...
class Peerforest_ExtraConfig_Model_Adminhtml_Css_Generator
{
  ...
  {    
    $this->_cssFileName[] = "grid";
    $this->_cssFileName[] = "layout";
    ...
    foreach($this->_cssFileName as $filename) {             
      $this->_themeSkinCssPath = Mage::getBaseDir()."/skin/frontend/modello/default/css/config/".$filename.$overridefilename.".css";      
      $updateCss = Mage::getBaseDir('design')."/frontend/modello/default/template/override/".$filename.".phtml";      
